    ...
    return (
        <div className="flex-card">
          <button onClick={this.getJSON}
            disabled={this.props.promo.disableDiscount}>
            {!this.props.promo.disableDiscount ? "Cycle Products" : "Can't Cycle Products"}
          </button>
          ...
          <Details productName={this.state.productName}
            ...
            detailsMounted={this.props.detail.detailsMounted}
            toggleDetailsWell={this.props.toggleDetailsWell}/>
          <hr/>
